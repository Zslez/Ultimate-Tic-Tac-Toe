...
const std::vector<int> smallBoardsNextMap = {
    0, 1, 2, 0, 1, 2, 0, 1, 2,
    3, 4, 5, 3, 4, 5, 3, 4, 5,
    6, 7, 8, 6, 7, 8, 6, 7, 8,
    0, 1, 2, 0, 1, 2, 0, 1, 2,
...
const std::vector<int> smallBoardsPrevMap = {
    0, 0, 0, 1, 1, 1, 2, 2, 2,
    0, 0, 0, 1, 1, 1, 2, 2, 2,
    0, 0, 0, 1, 1, 1, 2, 2, 2,
    3, 3, 3, 4, 4, 4, 5, 5, 5,
...
const std::vector< std::vector<int> > smallBoardWinMap = {
    // rows
...
const std::vector< std::vector<int> > bigBoardWinMap = {
    // rows
